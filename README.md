...
## 주요 기능
- 📝 체계적인 회의록 관리
  -> [https://www.notion.so/2adfef49d8d580ef895dece999fdef07?source=copy_link](https://www.notion.so/2adfef49d8d580ef895dece999fdef07?source=copy_link)
...
- 📚 프로젝트 문서화
   -> [https://www.notion.so/2adfef49d8d5800e9a3fc0022650fb04?source=copy_link](https://www.notion.so/2adfef49d8d5800e9a3fc0022650fb04?source=copy_link)
...
- 📊 칸반 보드 (GitHub Projects)를 통한 작업 관리
   -> 기획단계(깃칸반) : [https://github.com/orgs/skRookies4team/projects/3](https://github.com/orgs/skRookies4team/projects/3)
   -> 개발단계(깃칸반)  : [https://github.com/orgs/skRookies4team/projects/3](https://github.com/orgs/skRookies4team/projects/3)
